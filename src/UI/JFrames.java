...
public class JFrames extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        blockButton.setBackground(new java.awt.Color(0x1E90FF));
        blockButton.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        enemyHeroLabel.setFont(new java.awt.Font("Tahoma", 2, 14)); // NOI18N

        enemyDamageLabel.setBackground(new java.awt.Color(255, 255, 255));
        enemyDamageLabel.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        enemyDamageLabel.setText("Damage");

        playerDamageLabel.setBackground(new java.awt.Color(255, 255, 255));
        playerDamageLabel.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        playerDamageLabel.setText("Damage");

        playerDamageValueLabel.setBackground(new java.awt.Color(255, 255, 255));
        playerDamageValueLabel.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        playerDamageValueLabel.setForeground(new java.awt.Color(0xFF4500));
        playerDamageValueLabel.setText("16");

        enemyDamageValueLabel.setBackground(new java.awt.Color(255, 255, 255));
        enemyDamageValueLabel.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        enemyDamageValueLabel.setForeground(new java.awt.Color(0xFF4500));
        enemyDamageValueLabel.setText("16");

        playerLevelLabel.setBackground(new java.awt.Color(255, 255, 255));
        playerLevelLabel.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        playerLevelLabel.setText("0 уровень");

        fightLabel.setBackground(new java.awt.Color(255, 255, 255));
        fightLabel.setFont(new java.awt.Font("Tahoma", 3, 36)); // NOI18N
        fightLabel.setForeground(new java.awt.Color(0xFFFFFF));
        ...
        playerHealthLabel.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        enemyLevelLabel.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        ...
        recordsTableLabel.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        ...
        closeRecordsTableButton.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        ...
        endGameWithoutLadderTitlleLabel.setFont(new java.awt.Font("Tahoma", 3, 24)); // NOI18N
        ...
        notInLadderLabel.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        endGameWithoutLadderButton.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        ...
        itemsBagLabel.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        ...
        firstItemButton.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        ...
        secondItemButton.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        ...
        cantUseItemLabel.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        ...
        unavailableItemLabel.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        ...
        closeCantUseItemButton.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        ...
        seeResultsButton.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
